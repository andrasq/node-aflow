...
function repeatUntil( func, callback ) {
    ...
    function _loop( func, callback, callDepth ) {
        try {
            ...
            // be sure to not call the callback more than once.
            // If the user callback throws an error, and the callback itself
            // is in a try-catch block, I`ve seen multiple errors generated
            // and vectored here, all from the same call.  
            if (!caughtError) {
                caughtError = e;
                callback(e);
            }
